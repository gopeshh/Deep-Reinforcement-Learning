...
class StateProcessor():
    ...
    def __init__(self):
        ...
        with tf.variable_scope("state_processor"):
            ...
            self.output = tf.image.crop_to_bounding_box(self.output, 0, 0, 84, 84)
...
experiment_dir = os.path.abspath("./experiments/grid")
...
with tf.Session() as sess:
    ...
    for t, stats in deep_q_learning(sess,
        ...
        rewards_list.append(stats.episode_rewards[-1])
plt.close()
plt.plot(range(num_of_episodes), rewards_list)
plt.show()
